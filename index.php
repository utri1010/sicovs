...
<body class="login">
	...
	<div class="box redondear">
		<div class="content">
			<!-- Login Formular -->
                        <form class="form-vertical login-form " action="controlador/login.php" method="POST">
				<!-- Title -->
				...
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="icon-user"></i>
                                                <input type="text" name="user" class="form-control" placeholder="Username" autofocus="autofocus" data-rule-required="true"  data-msg-required="porfavor ingrese su usuario." />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="icon-lock"></i>
                                                <input type="password" name="pass" class="form-control" placeholder="Password" data-rule-required="true"  data-msg-required="porfavor ingrese su contraseña." />
					</div>
				</div>
				<!-- /Input Fields -->
				...
				<div class="form-actions">
                                    <label class="checkbox pull-left">
                                          <?php if(isset($_GET['error'])=='on'){echo "<p style='color:#b94a48'>Usuario y/o contraseña incorrecta</p>";} ?>
                                        </label>
